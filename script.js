...
function mainProjectsOffset() {
    ...
    document.getElementById('main-projects-container').style.paddingTop = topOffset + "px"
    document.getElementById('main-projects-container').children[0].style.marginBottom = topOffset + 'px'
